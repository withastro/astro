...
- b61b462: Fix astro check not being able to load TypeScript even when the path was right, updated `astro check` result to include a full URI instead of a wrongly formatted path

### Patch Changes

- ccf1902: Add support for "moduleResolution: 'node16'"
