...
describe('collect images', async () => {
    ...
    it('should collect inline image paths', async () => {
        ...
        chai
            .expect(code)
            .to.equal('<p>Hello <img alt="inline image url" __ASTRO_IMAGE_="{&#x22;src&#x22;:&#x22;./img.png&#x22;}"></p>');
    ...
    it('should add image paths from definition', async () => {
        ...
        chai.expect(code).to.equal('<p>Hello <img alt="image ref" __ASTRO_IMAGE_="{&#x22;src&#x22;:&#x22;./img.webp&#x22;}"></p>');
