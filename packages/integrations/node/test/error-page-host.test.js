...
describe('Prerendered error page host', () => {
    ...
    it('requests prerendered 404 page from the configured host', async () => {
        ...
        assert.ok(errorPageRequests.includes('/404.html'), 'Error page host should receive request for 404.html');
		...
		it('requests prerendered 500 page from the configured host', async () => {
				...
				assert.ok(errorPageRequests.includes('/500.html'), 'Error page host should receive request for 500.html');
