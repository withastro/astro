...
> ⚠️ This integration will be deprecated in Astro v3.0 (Fall 2023) in favour of the `astro:assets` module. Please see the [Assets documentation](https://docs.astro.build/en/guide/assets/) for more information.
