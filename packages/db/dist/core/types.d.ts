...
export interface TableConfig<TColumns extends ColumnsConfig = ColumnsConfig> extends Pick<
...
/** @deprecated */
interface LegacyIndexConfig<TColumns extends ColumnsConfig> extends z.input<
	typeof resolvedIndexSchema
> {
	on: MaybeArray<Extract<keyof TColumns, string>>;
}
