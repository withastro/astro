...
import { getAstroEnv, getDbDirectoryUrl, getRemoteDatabaseInfo } from '../utils.js';
const resolved = {
...
function getLocalVirtualModContents({ tables, root, localExecution }) {
...
function getRemoteVirtualModContents({ tables, appToken, isBuild, output, localExecution }) {
