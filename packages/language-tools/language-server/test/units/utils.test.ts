...
describe('Utilities', async () => {
	...
	it('rewriteComponentImportText - turns component named imports into default imports', () => {
		assert.strictEqual(
			rewriteComponentImportText(`import { Image } from "../components/Image.astro";\n`),
			`import Image from "../components/Image.astro";\n`,
		);
	});

	it('rewriteComponentImportText - keeps named imports that are not the component itself', () => {
		assert.strictEqual(
			rewriteComponentImportText(`import { Props } from "../components/Image.astro";\n`),
