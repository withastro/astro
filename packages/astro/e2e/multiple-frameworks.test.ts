...
test.skip('Multiple frameworks', () => {
	test.skip('React counter', async ({ page, astro }) => {
	...
	test('Preact counter', async ({ page, astro }) => {
		await page.goto(astro.resolveUrl('/'));
	...
	test.skip('Solid counter', async ({ page, astro }) => {
		await page.goto(astro.resolveUrl('/'));
	...
	test('Vue counter', async ({ page, astro }) => {
		await page.goto(astro.resolveUrl('/'));
	...
	test('Astro components', async ({ page, astro }) => {
		await page.goto(astro.resolveUrl('/'));
