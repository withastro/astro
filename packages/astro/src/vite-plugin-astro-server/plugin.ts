...
import { trailingSlashMiddleware } from '../vite-plugin-utils/trailing-slash-middleware.js';
	...
	return {
		...
		configureServer(viteServer) {
			...
			return () => {
				...
				viteServer.middlewares.use(trailingSlashMiddleware(settings.config.trailingSlash, logger));
