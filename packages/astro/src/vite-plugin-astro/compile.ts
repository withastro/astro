...
export async function compileAstro({
	...
	return {
		...
		// The Rust compiler returns an empty string when source maps are not yet implemented.
		// Rollup/Vite will try to JSON.parse the map, so we must return undefined instead.
