...
// Additionally, this code, much like `@types/astro.ts` will be used to generate documentation in the future,
// so make sure to pass your changes by our wonderful docs team before merging!
...
See https://docs.astro.build/en/guides/server-side-rendering/ for more information on non-static rendering.`,
	...
	ReservedSlotName: {
		...
		message: (slotName: string) =>
			`Unable to create a slot named "${slotName}". ${slotName}" is a reserved slot name!\nPlease update the name of this slot.`,
	},
	NoAdapterInstalled: {
		code: 3017,
