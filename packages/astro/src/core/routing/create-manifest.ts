...
// The `route` parameter is used as a fallback when `pathname` is null (dynamic routes), since
// the route string (from joinSegments) preserves file extensions even for dynamic segments.
