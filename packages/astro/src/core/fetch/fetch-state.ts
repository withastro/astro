...
export class FetchState implements AstroFetchState {
	...
	createAstro(
		...
		// per-instance Object.defineProperty() call. The getter reads
		// _slotResult / _slotValues / _slotLogger from `this` (the
		// component-level Astro object).
	...
	createAstroPagePartial(
		...
		const partial: Record<string, any> = {
			...
			// the component object, shadowing this prototype getter.
		...
		return partial as Omit<AstroGlobal, 'props' | 'self'>;
	}
