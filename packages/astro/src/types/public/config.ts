		...
		csp?:
           ...
           * ```
			     ...
			     * with the `resources` property, or to provide additional `hashes` to be rendered.
				   *
           * These properties are added to all pages and completeley override Astro's default resources, not add to them.
           ...
           * These properties are added to all pages and completeley override Astro's default resources, not add to them.
					...
					scriptDirective?: {
						 ...
						 * @description
						 *
						 * A list of additional hashes added to the `sript-src` directive.
             *
