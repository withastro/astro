...
> {
	...
	markdown?: {
		 ...
		 * This uses the @mdx-js/mdx-rs package to provide 7-20x speedup over the JavaScript implementation.
	...
	experimental?: {
		 ...
		 * When enabled, MDX compilation will use the Rust compiler with automatic fallback to JavaScript on errors.
		 *
		 * Note: This feature requires the @mdx-js/mdx-rs package to be installed as an optional dependency.
