...
/**
 * The `EndpointContext` is the object made available to endpoints and middleware.
...
> extends AstroSharedContext<Props, Params> {
	 ...
	 * }
	 *
	 * export async function GET({ params }: EndpointContext) {
	 ...
	 */
	params: AstroSharedContext<Props, EndpointParams>['params'];
	/**
	 ...
	 * }
	 *
	 * export function GET({ props }: EndpointContext): Response {
	 ...
	 */
	props: AstroSharedContext<Props, EndpointParams>['props'];
	/**
...
/**
 * @deprecated Use `EndpointContext` instead. This type will be removed in Astro 7.0.
 */
export type APIContext<
	Props extends Record<string, any> = Record<string, any>,
	APIParams extends Record<string, string | undefined> = Record<string, string | undefined>,
> = EndpointContext<Props, APIParams>;
