import type { RouteInfo, SSRManifest, SSRManifestCSP } from '../../../dist/core/app/types.js';
...
export function createManifest({
	...
	return {
		...
		trailingSlash: trailingSlash as AstroConfig['trailingSlash'],
		buildFormat: 'directory' as const,
		compressHTML: false,
		assetsPrefix: undefined,
		renderers: [],
		serverLike,
		middlewareMode: 'classic' as const,
