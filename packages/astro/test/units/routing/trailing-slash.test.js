...
const fileSystem = {
	...
	'/src/pages/pathname.ts': `export const GET = (ctx) => Response.json({ pathname: ctx.url.pathname })`,
	'/src/pages/subpage.ts': `export const GET = (ctx) => Response.json({ pathname: ctx.url.pathname })`,
};
