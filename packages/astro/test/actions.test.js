...
describe('Astro Actions', () => {
	...
	describe('dev', () => {
		...
		it('Redirects with cookies preserved', async () => {
			const res = await fixture.fetch('/redirect', {
				headers: {
					cookie: 'subscribed=true; Path=/',
				},
			});
	...
	describe('build', () => {
		...
		// 	const req = new Request('http://example.com/subscribe');
		// 	const res = await app.render(req, { addCookieHeader: true });
		// 	assert.equal(res.ok, true);
		// 	console.log('headers', res.headers);

		// 	const cookies = res.headers.get('Set-Cookie');
		// 	assert.equal(cookies, 'subscribed=true; path=/');
		// })

	// 	it('Redirects with cookies preserved', async () => {
	// 		const req = new Request('http://example.com/redirect', {
	// 			headers: {
	// 				cookie: 'subscribed=true; Path=/',
	// 			},
	// 		});
	...
	// 		const res = await app.render(new Request(new URL(Location, 'https://example.com/'), {
	// 			headers: {
	// 				cookie,
	// 			}
	// 		}));
