...
describe('Preview Routing', () => {
	describe('Subpath without trailing slash and trailingSlash.page: never', () => {
	...
	describe('Subpath without trailing slash and trailingSlash.page: always', () => {
		/** @type {import('./test-utils').Fixture} */
		let fixture;
		/** @type {import('./test-utils').PreviewServer} */
		let previewServer;
	...
	describe('Subpath without trailing slash and trailingSlash.page: ignore', () => {
		/** @type {import('./test-utils').Fixture} */
		let fixture;
		/** @type {import('./test-utils').PreviewServer} */
		let previewServer;
