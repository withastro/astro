...
Updates `astro add cloudflare` to always use the todays day as `compatibility_date` in the wrangler config, adapting to deprecation due to [upstream changes](https://github.com/cloudflare/workers-sdk/pull/13051)
