...
Adds shared helper utilities for CDN cache provider authors for [experimental route caching](https://docs.astro.build/en/reference/experimental-flags/route-caching/)
