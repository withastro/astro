...
You can now configure a maximum allowed request body size for your Node standalone server. The default limit is 1 GB. Set the value in bytes, or pass `0` to disable the limit entirely:
