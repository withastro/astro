...
Astro let you use any Markdown parser you want. It just need to be a function that follows the `MarkdownParser` type declared inside [this file](https://github.com/snowpackjs/astro/blob/latest/packages/astro/src/@types/astro.ts). You can declare it inside `astro.config.mjs`:
