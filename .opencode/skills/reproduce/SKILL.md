...
### 6c: `comment.md` — Concise GitHub issue reply for humans

Write a self-contained GitHub comment ready to post. This is formatted for fast reading by maintainers and issue authors.

**If the issue was reproduced:**
...
### Error Observed
```
[Error message / key stack trace snippet]
```
...
**If the issue could NOT be reproduced:**
...
[Reason this couldn't be triaged automatically.]

### Recommendations
[What should happen next]

---
*This comment was generated by automated triage.*
```

**Skip reason messages:**
- `host-specific`: "This issue appears to be specific to [provider] deployment. Automated reproduction can only test local development and build."
...
- `unsupported-runtime`: "This issue appears specific to [runtime]. Automated triage only supports Node.js."
...
The comment should be **concise**, **actionable**, **friendly**, and **accurate** — only state what was actually observed.
